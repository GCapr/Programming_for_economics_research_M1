...
(function() {
  ...
  window.PRACTICE_EXERCISES.data_cleaning = {
    ...
    // -----------------------------------------------------------------------
    beginner: [
      // 1 — read (Python): dropna subset parameter
      {
        type: "read",
        title: "Targeted Missing Value Removal with dropna(subset=)",
      ...
      {
        type: "read",
        title: "Converting Strings to Numbers with destring",
      ...
      // 3 — bug (R): forgetting reassignment after subsetting
      {
        type: "bug",
        title: "Subsetting Without Reassignment in R",
      ...
      // 4 — bug (R): implicit type coercion with string functions
      {
        type: "bug",
        title: "Implicit Type Coercion with str_pad on Numeric Data",
      ...
      // 5 — reorder (Python): basic cleaning pipeline order
      {
        type: "reorder",
        title: "Why Order Matters: Drop Missing Before Type Conversion",
      ...
      // 6 — reorder (Stata): destring before numeric operations
      {
        type: "reorder",
        title: "Why destring Must Come Before Numeric Operations",
      ...
      // 7 — fill (Python): fillna with column mean
      {
        type: "fill",
        title: "Mean Imputation with fillna() in Python",
      ...
      {
        type: "match",
        title: "Core Cleaning Operations Across Languages",
    ...
    // -----------------------------------------------------------------------
    intermediate: [
      // 1 — read (Python): string method chaining
      {
        type: "read",
        title: "String Cleaning Chain: strip, lower, replace",
      ...
      // 2 — read (R): case_when for conditional recoding
      {
        type: "read",
        title: "Conditional Recoding with case_when in R",
      ...
      // 3 — bug (Python): regex=True requirement in pandas str.replace
      {
        type: "bug",
        title: "Why str.replace Needs regex=True for Patterns",
      ...
      // 4 — bug (Stata): missing() with multiple variables drops too many rows
      {
        type: "bug",
        title: "missing() with Multiple Variables Drops Too Many Rows",
      ...
      // 5 — reorder (Python): create missing indicator before imputation
      {
        type: "reorder",
        title: "Create Missing Indicator Before Imputation",
      ...
      // 6 — reorder (R): deduplicate before computing quantiles
      {
        type: "reorder",
        title: "Deduplicate Before Computing Quantile Bounds",
      ...
      // 7 — fill (Stata): replace...if pattern for conditional assignment
      {
        type: "fill",
        title: "Conditional Replacement with replace...if in Stata",
    ...
    // -----------------------------------------------------------------------
    advanced: [
      // 1 — read (Python): np.where boundary condition
      {
        type: "read",
        title: "Boundary Conditions in np.where: Zero Is Not Positive",
      ...
      // 2 — read (Stata): interpreting _merge diagnostics
      {
        type: "read",
        title: "Interpreting Stata Merge Diagnostics (_merge)",
      ...
      // 3 — bug (Python): mean imputation reduces variance
      {
        type: "bug",
        title: "Mean Imputation Artificially Reduces Variance",
      ...
      // 4 — bug (R): string methods on numeric columns
      {
        type: "bug",
        title: "String Cleaning on a Numeric Column Causes Silent Coercion",
      ...
      // 5 — reorder (Python): full cleaning pipeline order
      {
        type: "reorder",
        title: "Full Cleaning Pipeline: Dedup, Indicator, Quantiles, Impute, Clip",
      ...
      // 6 — reorder (Stata): merge, inspect, filter, cleanup
      {
        type: "reorder",
        title: "Stata Merge Workflow: Merge, Inspect, Filter, Drop _merge",
      ...
      // 7 — fill (R): winsorization with pmin/pmax
      {
        type: "fill",
        title: "Two-Sided Clipping with pmin/pmax in R",
      ...
      // 8 — match: data quality checks across languages
      {
        type: "match",
        title: "Data Quality Diagnostics Across Languages",
  ...
  window.PRACTICE_EXERCISES.data_analysis = {
    ...
    // -----------------------------------------------------------------------
    beginner: [
      // 1 — read (Python): cov_type='HC1' for robust SEs
      {
        type: "read",
        title: "Specifying Robust Standard Errors with cov_type='HC1'",
      ...
      // 2 — read (Stata): interpreting reg command syntax
      {
        type: "read",
        title: "Stata reg Command: i. Prefix and robust Option",
      ...
      // 3 — bug (Python): .fit() without cov_type defaults to classical SEs
      {
        type: "bug",
        title: "Default Classical SEs May Be Unreliable",
      ...
      // 4 — bug (R): * vs : in formula interaction syntax
      {
        type: "bug",
        title: "R Formula: * Includes Main Effects, : Does Not",
      ...
      // 5 — reorder (Python): OLS estimation workflow
      {
        type: "reorder",
        title: "OLS Workflow: Import, Define, Fit, Display",
      ...
      // 6 — reorder (R): regression then table export with modelsummary
      {
        type: "reorder",
        title: "R Workflow: Estimate Models then Export Table",
      ...
      // 7 — fill (Stata): cluster() option for clustered SEs
      {
        type: "fill",
        title: "Clustered Standard Errors with cluster() in Stata",
      ...
      // 8 — match: regression commands across languages
      {
        type: "match",
    ...
    // -----------------------------------------------------------------------
    intermediate: [
      // 1 — read (Python): cov_type='cluster' with cov_kwds
      {
        type: "read",
        title: "Clustered SEs: cov_type='cluster' with cov_kwds",
      ...
      // 2 — read (R): feols two-way fixed effects syntax
      {
        type: "read",
        title: "feols Syntax: Fixed Effects After | vs cluster Argument",
      ...
      // 3 — bug (Python): logit coefficients are log-odds, not probabilities
      {
        type: "bug",
        title: "Logit Coefficients Are Log-Odds, Not Probabilities",
      ...
      // 4 — bug (Stata): controlling for a post-treatment variable
      {
        type: "bug",
        title: "Post-Treatment Variable Bias in a Regression",
      ...
      // 5 — reorder (R): logit then marginal effects
      {
        type: "reorder",
        title: "Logit Workflow: Estimate then Compute Marginal Effects",
      ...
      // 6 — reorder (Stata): xtset then xtreg for panel data
      {
        type: "reorder",
        title: "Panel Data: xtset Before xtreg in Stata",
      ...
      // 7 — fill (R): * operator for interaction with main effects
      {
        type: "fill",
        title: "R Formula Shorthand: * for Main Effects Plus Interaction",
      ...
      // 8 — match: interpreting regression output statistics
      {
        type: "match",
        title: "Interpreting Key Regression Output Statistics",
    ...
    // -----------------------------------------------------------------------
    advanced: [
      // 1 — read (Python): counting coefficients with : interaction
      {
        type: "read",
        title: "Counting Coefficients: : Creates Only the Interaction",
      ...
      // 2 — read (Stata): esttab keep() option
      {
        type: "read",
        title: "esttab keep() Controls Which Coefficients Are Displayed",
      ...
      // 3 — bug (Python): HC1 does not handle within-cluster correlation
      {
        type: "bug",
        title: "HC1 Is Not Enough for Panel Data: Need Clustered SEs",
      ...
      // 4 — bug (R): missing factor levels in bootstrap resamples
      {
        type: "bug",
        title: "Bootstrap Drops Factor Levels in Some Resamples",
      ...
      // 5 — reorder (R): bootstrap SE computation steps
      {
        type: "reorder",
        title: "Bootstrap SE: Resample, Estimate, Store, Compute SD",
      ...
      // 6 — reorder (Stata): stepwise model building with eststo/esttab
      {
        type: "reorder",
        title: "Stepwise Model Building: eststo Clear, Estimate, Display",
      ...
      // 7 — fill (Python): passing a list of models to Stargazer
      {
        type: "fill",
        title: "Stargazer Expects a List of Fitted Models",
      ...
      // 8 — match: diagnostic commands across languages
      {
        type: "match",
        title: "Estimation Diagnostics Across Languages",
  ...
  window.PRACTICE_EXERCISES.causal_inference = {
    ...
    // -----------------------------------------------------------------------
    beginner: [
      // 1 — read (Stata): DiD interaction term is the treatment effect
      {
        type: "read",
        title: "DiD: The Interaction Coefficient Is the Treatment Effect",
      ...
      // 2 — read (R): matchit() estimates propensity scores and pairs units
      {
        type: "read",
        title: "Propensity Score Matching: What matchit() Does",
      ...
      // 3 — bug (Stata): robust does not handle serial correlation in DiD panels
      {
        type: "bug",
        title: "DiD Panels Need cluster(), Not Just robust",
      ...
      // 4 — bug (Python): weak instrument (F < 10)
      {
        type: "bug",
        title: "Weak Instrument: First-Stage F-Statistic Below 10",
      ...
      {
        type: "reorder",
        title: "DiD Setup: Load, Create Post, Create Interaction, Estimate",
      ...
      // 6 — reorder (R): RDD estimation with rdrobust
      {
        type: "reorder",
        title: "RDD Workflow: Load Package, Bandwidth, Estimate, Display",
      ...
      // 7 — fill (Stata): ivregress 2sls syntax
      {
        type: "fill",
        title: "Stata IV Syntax: (endogenous = instrument)",
      ...
      // 8 — match: causal methods and their core identifying assumptions
      {
        type: "match",
        title: "Each Causal Method Has a Core Identifying Assumption",
    ...
    // -----------------------------------------------------------------------
    intermediate: [
      // 1 — read (R): TWFE coefficient interpretation
      {
        type: "read",
        title: "TWFE: What the treated Coefficient Identifies",
      ...
      // 2 — read (Stata): event study ref = -1 normalization
      {
        type: "read",
        title: "Event Study: Why ref = -1 Is the Standard Reference",
      ...
      // 3 — bug (R): matching on a post-treatment variable
      {
        type: "bug",
        title: "Matching on Post-Treatment Variables Introduces Bias",
      ...
      // 4 — bug (Python): global polynomial RDD is unreliable
      {
        type: "bug",
        title: "Global Polynomial RDD Is Driven by Distant Observations",
      ...
      // 5 — reorder (R): event study with iplot
      {
        type: "reorder",
        title: "Event Study: Compute rel_time, Estimate, Plot",
      ...
      // 6 — reorder (Stata): IV with post-estimation diagnostics
      {
        type: "reorder",
        title: "IV Workflow: Estimate, Check Strength, Test Endogeneity",
      ...
      // 7 — fill (Python): rdrobust cutoff parameter
      {
        type: "fill",
        title: "rdrobust: Specifying the Cutoff with c=",
      ...
      {
        type: "match",
        title: "Causal Inference Implementations Across Languages",
    ...
    // -----------------------------------------------------------------------
    advanced: [
      // 1 — read (R): synthetic control donor weighting
      {
        type: "read",
        title: "Synthetic Control: Optimal Donor Weights, Not Equal Averaging",
      ...
      // 2 — read (Stata): Sargan-Hansen overidentification test
      {
        type: "read",
        title: "Overidentification Test: High p-Value Means No Evidence Against Validity",
      ...
      // 3 — bug (R): event study with ref = 0 instead of ref = -1
      {
        type: "bug",
        title: "Event Study ref = 0 Makes Pre-Trends Uninterpretable",
      ...
      // 4 — bug (Stata): RDD needs bandwidth sensitivity analysis
      {
        type: "bug",
        title: "RDD Robustness: Report Results at h/2, h, and 2h",
      ...
      // 5 — reorder (Python): synthetic control analysis flow
      {
        type: "reorder",
        title: "Synthetic Control: Import, Load, Fit, Plot, Placebo",
      ...
      // 6 — reorder (Python): propensity score matching with balance check
      {
        type: "reorder",
        title: "PSM Workflow: Score, Match, Construct Sample, Check Balance",
      ...
      // 7 — fill (R): i(rel_time, ref = -1) for event study
      {
        type: "fill",
        title: "fixest Event Study: i(rel_time, ref = -1)",
      ...
      // 8 — match: signature robustness tests for each causal method
      {
        type: "match",
        title: "Each Causal Method Has a Signature Robustness Test",
